...
(function (m, n) {
    angular.module("ng.ckeditor", ["ng"]).directive("ngCkeditor", function () {
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            restrict: "E", scope: 
            { ngModel: "=ngModel", ngChange: "=ngChange", 
            ngDisabled: "=ngDisabled", ngConfig: "=ngConfig" }, 
            link: function (a, c, b) {
                c[0].innerHTML = '<div class="ng-ckeditor"></div> <div class="totalTypedCharacters"></div>'; 
                var h = c[0].querySelectorAll(".ng-ckeditor"), d = { removeButtons: void 0 != b.removeButtons ? "About," + b.removeButtons : "About", readOnly: a.ngDisabled ? a.ngDisabled : !1 }; void 0 != b.removePlugins && (d.removePlugins = b.removePlugins); void 0 != b.skin && (d.skin = b.skin); void 0 != b.width &&
