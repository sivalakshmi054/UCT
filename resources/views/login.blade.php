            ...
            <div class="col-md-6 align-self-center">
                <div class="loginContainer">
                    ...
                    <form >
                        ...
                        <button type="submit" class="btn btn-primary btn-block" ng-click="UserLogin_AddEdit()">Login</button>
                    </form>
                </div>
            </div>
        </div>
...
<p><input type="checkbox" name="check">I have read the Terms and conditions and the privacy policy. </p> 
        ...
        <br><br>
        <a href="Home#/Home">
        <button type="submit" class="btn btn-secondary"  style="background-color:grey; width:50px;">Ok</button></a>
